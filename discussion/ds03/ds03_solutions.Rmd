...
---
title:  "STAT340: Discussion 3: Hypothesis Testing SOLUTIONS"
...
```{r}
# Running your permutation test should yield lots of values that are between 02 and 2; it is very unlikely that you will see a value as extreme as the beta_1=7.678 that we got from fitting to the non-permuted data.

# That is the point! The fact that the coefficient for the true data is so much more extreme than the values that we see on the random permutations suggests that there is something special about the data that we actually observed!
```
