...
__Exercise:__ compute the expectation of a Bernoulli random variable with success probability $p$. What about a $\Binomial(n,p)$ random variable? __Hint:__ the expectation of a sum of RVs is the sum of their expectations. Write the Binomial RV as a sum of Bernoullis.
...
Of course, the curve extends out to infinity on the right and negative infinitey on the left; we just haven't plotted it.
