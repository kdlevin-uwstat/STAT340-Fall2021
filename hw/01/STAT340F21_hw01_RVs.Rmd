...
To see what the distributions of different random variables look like, generate 1,000 copies of the random variables above and put them in a histogram:

```{r}
# Exponential:
hist(rexp(n = 1000, lambda=1/5))
# or 
library(magrittr)
rexp(10000, lambda=1/5) %>% hist
...
# Exponential:
hist(rexp(n = 1000,size = 1,rate = 1))
# or 
library(magrittr)
rexp(1000,size=1,rate=1) %>% hist
